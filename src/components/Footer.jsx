    ...
    <footer className="footer">
      ...
      <p style={{ marginTop: '0.5rem' }}>
        <small>
          ...
          <a 
            href="https://wa.me/5585997231255?text=oi,%20quero%20saber%20mais%20sobre%20o%20Retiro" 
            target="_blank" 
            rel="noopener noreferrer"
            style={{ color: 'var(--accent-color)', textDecoration: 'underline', display: 'inline-flex', alignItems: 'center' }}
          >
